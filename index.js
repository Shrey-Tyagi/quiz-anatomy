...
var quizData = [
  ...
  {
    question:
      'Which organelle present inside our cells is resonsible for engergy?',
    answer: 'Mitochondria',
  },
];
...
function welcome() {
  ...
  console.log(
    chalk.blue(
      'Welcome! ' +
        chalk.red(username) +
        ' Get ready to test your Anatomical knowelege\n\n'
    ) +
      chalk.cyan(
...
function game() {
  for (var quizObj of quizData) {
    ...
    if (answerUser.toUpperCase() === quizObj.answer.toUpperCase()) {
      ...
      console.log(
        chalk.blue('The correct answer is ') +
          chalk.bgGreen(quizObj.answer) +
          chalk.blue(' Better luck next time :(\n')
      );
      score--;
    }
  }
